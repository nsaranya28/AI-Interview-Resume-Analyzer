...
<div class="admin-layout">
    <!-- Sidebar -->
    <aside class="admin-sidebar" style="background:#ffffff;">
        <div style="margin-bottom:24px;">
            <div style="width:50px;height:50px;border-radius:12px;background:linear-gradient(135deg,var(--primary),var(--accent));display:flex;align-items:center;justify-content:center;font-size:22px;margin-bottom:10px;">👑</div>
    ...
    <main class="admin-content">
        ...
        <div class="metric-cards">
            <div class="metric-card" style="border-color:rgba(220, 38, 38, 0.15);">
                ...
                <div class="admin-table-wrapper">
                    <table class="admin-table">
                        ...
                        <tbody>
                            ...
                            <tr style="<?= $isActive ? 'background:var(--primary-glow);' : '' ?>">
