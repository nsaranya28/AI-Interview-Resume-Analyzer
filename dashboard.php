                    ...
                    <?php else: ?>
                        <div style="display: flex; flex-direction: column; gap: 12px; max-height: 380px; overflow-y: auto; padding-right: 4px;">
                            <?php foreach ($resumes as $res): ?>
                                ...
                                ?>
                                <a href="dashboard.php?resume_id=<?php echo $res['id']; ?>" class="card-history-item" style="display: flex; justify-content: space-between; align-items: center; text-decoration: none; padding: 12px 16px; background: <?php echo $isActive ? 'var(--primary-glow)' : 'var(--bg-base)'; ?>; border: 1px solid <?php echo $isActive ? 'var(--border-color-active)' : 'var(--border-color)'; ?>; border-radius: var(--radius-sm); transition: var(--transition);">
                                    ...
                                    <div style="display: flex; flex-direction: column; align-items: flex-end;">
                                        <span class="score-num-sm <?php echo $scoreColor; ?>" style="font-size: 14px; font-weight: 800; color: <?php echo ($scoreColor === 'excellent') ? 'var(--text-dark)' : (($scoreColor === 'good') ? 'var(--text-main)' : 'var(--text-muted)'); ?>;"><?php echo $res['ats_score']; ?>%</span>
                    ...
                    <div id="report-view-container">
                        <h2 class="card-title" id="report-heading" style="border-bottom: 1px solid var(--border-color); padding-bottom: 15px; margin-bottom: 25px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px;">
                            <span style="display: flex; align-items: center; gap: 10px;">
                                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="color: var(--text-dark);"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                                Analysis Report Details
                            </span>
                            <!-- Edit/Update Resume Link -->
                            <button type="button" class="btn btn-secondary btn-sm" id="btn-edit-resume" onclick="toggleEditForm(true)" style="background: #1a1a1a; color: var(--text-dark); border: 1px solid var(--border-color); font-weight: 700; display: inline-flex; align-items: center; gap: 6px;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 30px; margin-bottom: 35px; align-items: center;">
                            ...
                            <div>
                                <h3 style="font-size: 22px; font-weight: 800; color: var(--text-dark); margin-bottom: 6px;"><?php echo htmlspecialchars($selectedResume['target_role']); ?></h3>
                                <p style="font-size: 13px; color: var(--text-muted); margin-bottom: 12px; display: flex; align-items: center; gap: 6px;">
                                    <strong style="color: var(--text-dark);">File:</strong> <?php echo htmlspecialchars($selectedResume['file_name']); ?>
                                </p>
                        ...
                        <div style="margin-bottom: 30px;">
                            <h4 style="font-size: 15px; font-weight: 700; color: var(--text-dark); margin-bottom: 10px; display: flex; align-items: center; gap: 6px;">
                            ...
                            <div style="background: rgba(255,255,255,0.01); border: 1px solid var(--border-color); border-radius: var(--radius-sm); padding: 18px;">
                                ...
                                <div>
                                    <p style="font-size: 12px; font-weight: 700; text-transform: uppercase; color: var(--text-main); letter-spacing: 0.05em; margin-bottom: 6px; display: flex; align-items: center; gap: 4px;">
                                ...
                                <?php else: ?>
                                    <ul style="margin: 0; padding-left: 20px; font-size: 13px; color: var(--text-muted); display: flex; flex-direction: column; gap: 8px;">
                                        <?php foreach ($analysisData['suggestions'] as $sug): ?>
                                            <li style="line-height: 1.5;"><strong style="color: var(--text-dark);">Improvement:</strong> <?php echo htmlspecialchars($sug); ?></li>
                                        <?php endforeach; ?>
                                    </ul>
                                <?php endif; ?>
                            </div>
                                ...
                                <?php else: ?>
                                    <ul style="margin: 0; padding-left: 20px; font-size: 13px; color: var(--text-muted); display: flex; flex-direction: column; gap: 8px;">
                                        <?php foreach ($analysisData['grammar_issues'] as $issue): ?>
                                            <li style="line-height: 1.5;"><span style="color: var(--text-main);">⚠</span> <?php echo htmlspecialchars($issue); ?></li>
                                        <?php endforeach; ?>
                                    </ul>
                                <?php endif; ?>
                            </div>
