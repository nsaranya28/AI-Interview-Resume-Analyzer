...
<head>
    ...
    <meta name="description" content="Candidate profile portal to review ATS reports, check tech skill alignments, and trigger mock interview chats.">
</head>
<body>
            ...
            <section class="card" style="min-height: 600px;" aria-labelledby="report-heading">
                ...
                <?php else: ?>
                    <h2 class="card-title" id="report-heading" style="border-bottom: 1px solid var(--border-color); padding-bottom: 15px; margin-bottom: 25px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px;">
                        ...
                        <!-- Mock Interview Link -->
                        <a href="interview.php?resume_id=<?php echo $selectedResume['id']; ?>" class="btn btn-primary btn-sm" id="btn-start-interview" style="background: linear-gradient(135deg, var(--primary) 0%, var(--accent) 100%);">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="margin-right: 4px;"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
