...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        body { background: #1a1a2e; font-family: 'Inter', sans-serif; padding: 20px; }
        ...
        .btn-pdf { background:linear-gradient(135deg,#6366f1,#a855f7); color:#fff; }
        ...
        /* Resume Paper */
        .resume-paper { max-width:850px; margin:0 auto; background:#fff; box-shadow:0 25px 60px rgba(0,0,0,.5); border-radius:4px; overflow:hidden; }
        
        /* ====== ATS Template ====== */
        .tpl-ats { font-family:'Inter',sans-serif; color:#1a1a1a; }
        .tpl-ats .header { background:#1e293b; color:#fff; padding:32px 40px; }
        .tpl-ats .header h1 { font-size:30px; font-weight:800; letter-spacing:-.5px; margin-bottom:4px; }
        .tpl-ats .header .headline { font-size:14px; color:#94a3b8; margin-bottom:12px; }
        .tpl-ats .header .contacts { display:flex; flex-wrap:wrap; gap:16px; font-size:12px; color:#cbd5e1; }
        ...
        .tpl-ats .section-title { font-size:11px; font-weight:700; text-transform:uppercase; letter-spacing:.1em; color:#6366f1; padding-bottom:6px; border-bottom:2px solid #e2e8f0; margin-bottom:14px; }
        .tpl-ats .summary-text { font-size:13px; line-height:1.7; color:#374151; }
        .tpl-ats .item-header { display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:4px; }
        .tpl-ats .item-title { font-size:14px; font-weight:700; color:#1e293b; }
        .tpl-ats .item-subtitle { font-size:13px; color:#475569; }
        .tpl-ats .item-date { font-size:12px; color:#64748b; white-space:nowrap; }
        .tpl-ats .item-desc { font-size:13px; color:#374151; line-height:1.6; margin-top:6px; white-space:pre-line; }
        .tpl-ats .skills-grid { display:flex; flex-wrap:wrap; gap:6px; }
        .tpl-ats .skill-chip { background:#f1f5f9; border-radius:4px; padding:4px 10px; font-size:12px; font-weight:600; color:#1e293b; }
        .tpl-ats .skill-chip.expert { border-left:3px solid #10b981; }
        .tpl-ats .skill-chip.advanced { border-left:3px solid #6366f1; }
        .tpl-ats .skill-chip.intermediate { border-left:3px solid #f59e0b; }
        .tpl-ats .skill-chip.beginner { border-left:3px solid #94a3b8; }
        
        /* ====== Professional Template ====== */
        .tpl-professional { font-family:'Inter',sans-serif; display:grid; grid-template-columns:250px 1fr; min-height:900px; }
        .tpl-professional .sidebar { background:#0f172a; color:#fff; padding:32px 24px; }
        .tpl-professional .sidebar .name { font-size:20px; font-weight:800; margin-bottom:4px; line-height:1.2; }
        .tpl-professional .sidebar .headline { font-size:12px; color:#94a3b8; margin-bottom:20px; }
        .tpl-professional .sidebar .s-section { margin-bottom:20px; }
        .tpl-professional .sidebar .s-title { font-size:10px; font-weight:700; text-transform:uppercase; letter-spacing:.1em; color:#6366f1; margin-bottom:10px; }
        .tpl-professional .sidebar .contact-row { font-size:11px; color:#cbd5e1; margin-bottom:6px; word-break:break-all; }
        ...
        .tpl-professional .sidebar .bar-fill { height:100%; background:linear-gradient(90deg,#6366f1,#a855f7); border-radius:2px; }
        .tpl-professional .main { padding:32px 28px; color:#1a1a1a; background:#fff; }
        .tpl-professional .main .section { margin-bottom:22px; }
        .tpl-professional .main .section-title { font-size:14px; font-weight:700; color:#0f172a; border-bottom:2px solid #6366f1; padding-bottom:6px; margin-bottom:14px; }
        .tpl-professional .item-header { display:flex; justify-content:space-between; align-items:flex-start; }
        .tpl-professional .item-title { font-size:13px; font-weight:700; color:#1e293b; }
        .tpl-professional .item-sub { font-size:12px; color:#475569; }
        .tpl-professional .item-date { font-size:11px; color:#64748b; }
        .tpl-professional .item-desc { font-size:12px; color:#374151; line-height:1.65; margin-top:5px; white-space:pre-line; }
        
        /* ====== Modern Template ====== */
        .tpl-modern { font-family:'Inter',sans-serif; color:#1a1a1a; }
        .tpl-modern .header { background:linear-gradient(135deg,#6366f1 0%,#a855f7 100%); color:#fff; padding:36px 40px; position:relative; }
        .tpl-modern .header::after { content:''; position:absolute; bottom:-20px; left:0; right:0; height:40px; background:#fff; clip-path:ellipse(100% 100% at 50% 100%); }
        ...
        .tpl-modern .section-title { font-size:16px; font-weight:800; color:#6366f1; margin-bottom:14px; display:flex; align-items:center; gap:8px; }
        .tpl-modern .section-title::before { content:''; width:4px; height:18px; background:linear-gradient(180deg,#6366f1,#a855f7); border-radius:2px; }
        ...
        .tpl-modern .item-sub { font-size:13px; color:#6366f1; }
        .tpl-modern .item-date { font-size:12px; color:#64748b; background:#f1f5f9; padding:2px 8px; border-radius:4px; }
        .tpl-modern .item-desc { font-size:13px; color:#475569; line-height:1.65; margin-top:6px; white-space:pre-line; }
        .tpl-modern .skill-tags { display:flex; flex-wrap:wrap; gap:8px; }
        .tpl-modern .skill-tag { background:linear-gradient(135deg,rgba(99,102,241,.1),rgba(168,85,247,.1)); border:1px solid rgba(99,102,241,.25); color:#6366f1; padding:4px 12px; border-radius:20px; font-size:12px; font-weight:600; }
        
        /* ====== Creative Template ====== */
        .tpl-creative { font-family:'Playfair Display','Inter',serif; }
        .tpl-creative .header { background:#0f172a; padding:40px; color:#fff; display:flex; justify-content:space-between; align-items:flex-start; }
        .tpl-creative .header h1 { font-size:36px; font-weight:700; margin-bottom:6px; background:linear-gradient(135deg,#f59e0b,#ef4444); -webkit-background-clip:text; -webkit-text-fill-color:transparent; }
        .tpl-creative .header .hl { font-family:'Inter',sans-serif; font-size:14px; color:#94a3b8; }
        .tpl-creative .header .contacts { font-family:'Inter',sans-serif; font-size:11px; color:#cbd5e1; text-align:right; line-height:2; }
        .tpl-creative .body { padding:32px 40px; font-family:'Inter',sans-serif; color:#1a1a1a; }
        .tpl-creative .section { margin-bottom:24px; }
        .tpl-creative .section-title { font-size:18px; font-weight:700; font-family:'Playfair Display',serif; color:#0f172a; margin-bottom:14px; padding-bottom:8px; border-bottom:2px solid #f59e0b; }
        .tpl-creative .item-title { font-size:14px; font-weight:700; color:#0f172a; }
        .tpl-creative .item-sub { font-size:12px; color:#f59e0b; font-weight:600; }
        .tpl-creative .item-date { font-size:11px; color:#64748b; }
        .tpl-creative .item-desc { font-size:13px; color:#374151; line-height:1.65; margin-top:5px; white-space:pre-line; }
        .tpl-creative .skill-tags { display:flex; flex-wrap:wrap; gap:8px; }
        .tpl-creative .skill-tag { background:#0f172a; color:#f59e0b; padding:4px 12px; border-radius:4px; font-size:12px; font-weight:600; }
...
<div class="tpl-ats">
    ...
    <div class="body">
        ...
        <div style="margin-bottom:14px;">
            ...
            <?php if ($proj['technologies']): ?><div class="item-subtitle" style="font-size:12px;color:#6366f1;margin:3px 0;">Tech: <?= htmlspecialchars($proj['technologies']) ?></div><?php endif; ?>
...
<div class="tpl-creative">
    ...
    <div class="body">
        ...
        <?php if (!empty($projects)): ?><div class="section"><div class="section-title">Projects</div><?php foreach ($projects as $proj): ?><div style="margin-bottom:14px;"><div class="item-title"><?= htmlspecialchars($proj['project_name']) ?></div><?php if ($proj['technologies']): ?><div style="font-size:12px;color:#0f172a;margin:3px 0;"><?= htmlspecialchars($proj['technologies']) ?></div><?php endif; ?><?php if ($proj['description']): ?><div class="item-desc"><?= $proj['description'] ?></div><?php endif; ?></div><?php endforeach; ?></div><?php endif; ?>
        <?php if (!empty($certs)): ?><div class="section"><div class="section-title">Certifications</div><div class="skill-tags"><?php foreach ($certs as $c): ?><span class="skill-tag"><?= htmlspecialchars($c['cert_name']) ?></span><?php endforeach; ?></div></div><?php endif; ?>
